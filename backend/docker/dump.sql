...
INSERT INTO product(seller_id, name, brand, product_description, quantity, total_price, sale_type) VALUES (1, 'Office chair', 'Basic', 'Pretty comfy chair', 6, 299.99, 'Regular'), (1, 'V4', 'Volvo', 'Not used much to be honest', 1, 52299.99, 'Regular'), (1, 'T100', 'Tesla', 'Exploited, barely usable', 1, 263299.99, 'Regular'), (1, 'B1', 'Bentley', 'A classic, pristine condition. No scratches, not even used. Without tires', 1, 300000.00, 'Auction');
